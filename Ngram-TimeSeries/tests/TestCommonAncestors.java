...
public class TestCommonAncestors {
    ...
    public void testSpecAdjustment() {
        ...
        NgordnetQuery nq = new NgordnetQuery(words, 0, 0, 0, NgordnetQueryType.ANCESTORS);
    ...
    public void testSpecAdjustment2() {
        ...
        List<String> words = List.of("hullo");

        NgordnetQuery nq = new NgordnetQuery(words, 1900, 2020, 2, NgordnetQueryType.ANCESTORS);
        String actual = studentHandler.handle(nq);
        String expected = "[communication, content]";
        assertThat(actual).isEqualTo(expected);
    }
}
